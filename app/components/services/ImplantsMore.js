      ...
      <View style={{ paddingTop: 30, flex: 1, padding: 15 }}>
        <View>
          ...
          <Text style={styles.itempicktext}>
            ...
            the post will serve as the tooth root, it's implanted deep into the
            bone. At this point, you'll still have a gap where your tooth is
            missing.
          ...
          <Text style={styles.itempicktext}>
            ...
            in an outpatient setting. To place the abutment:
            {"\n\n"}
          </Text>
          ...
          <Text style={styles.itempicktext}>
            ...
            it's visible when you open your mouth — and it will be that way
            until your dentist completes the tooth prosthesis.
            {"\n\n"}
            Some people don't like that appearance and prefer to have the
            abutment placed in a separate procedure. After the abutment is
            placed, your gums must heal for about two weeks before the
            artificial tooth can be attached.{"\n\n"}
          </Text>
