    ...
    return (
      <View>
        ...
        <Text style={styles.itemPickText}>
          {"\n"}
          At Advanced Dental Care of Norton, we have our own Pediatric Dentist!
          {"\n\n"}
          ...
          {"\n\n"}Pediatric Dentists are typically required to complete an extra
          two to three years of post-doctoral dental training, after which they
          are eligible for board certification by the American Board of
          Pediatric Dentistry. Pediatric dentists places special emphasis on the
          prevention of tooth decay, especially since there are studies which
          have shown that poor oral health in children can not only lead to
          impaired school performance, but also poor social relationships.
          {"\n\n"}In the same way that pediatricians are trained to meet a
          child's medical needs, our pediatric dentist is uniquely qualified to
          protect your child's oral health, using the most advanced techniques.
        </Text>
      </View>
    );
  }
