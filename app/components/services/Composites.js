    ...
    return (
      <View>
        ...
        <Text style={styles.itemPickText}>
          {"\n"}
          Composites are tooth colored resin fillings that are used in small to
          midsize cavities that provide durability and resistance to fractures
          and allow a tooth to withstand the pressure that comes from chewing.
          {"\n"}
          {"\n"}
          ...
          {"\n"}
          {"\n"}
          Composite fillings usually take longer to place then a metal (amalgam)
          filling because the tooth is needed to be kept clean and dry during
          the procedure.
          {"\n"}
          {"\n"}
          Composite fillings are now used more than metal alternatives because
          most people want fillings that match the color of their natural teeth.
          At our office we use a shade guide to match our many shades of
          composite resins to the natural color of our patient’s teeth.
        </Text>
      </View>
    );
  }
