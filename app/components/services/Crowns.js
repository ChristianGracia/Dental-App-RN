        ...
        <Text style={styles.itemPickText}>
          ...
          <Text>
            ...
            <Text>
              ...
              protects the tooth or filling while a permanent crown is made from
              another material. The crown covers the entire tooth and protects
              it from further decay. In general, stainless steel crowns are used
              for children's teeth because they don't require multiple dental
              visits to put in place and so are more cost- effective than
              custom-made crowns and prophylactic dental care needed to protect
            ...
            <Text>
              ...
              wearing to the opposing teeth occurs with this crown type compared
              with metal or resin crowns. The crown's porcelain portion can also
              chip or break off. Next to all-ceramic crowns,
              porcelain-fused-to-metal crowns look most like normal teeth.
              However, sometimes the metal underlying the crown's porcelain can
              show through as a dark line, especially at the gum line and even
              more so if your gums recede. These crowns can be a good choice for
              front or back teeth as well as long bridges where the metal is
              needed for strength.
              {"\n"}
              {"\n"}
            </Text>
            ...
            <Text>
              ...
              most permanent crowns are made in a dental laboratory. Typically,
              temporary crowns are made of an acrylic-based material or
              stainless steel and can be used as a temporary restoration until a
              permanent crown is constructed by a lab.
            </Text>
          </Text>
        </Text>
      </View>
