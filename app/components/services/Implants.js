    ...
    return (
      <View style={{ padding: 15 }}>
        ...
        <Text style={styles.itemPickText}>
          {"\n"}
          <Text style={{ fontWeight: "bold" }}>What are Dental Implants?</Text>
          {"\n\n"}
          ...
          {"\n\n"}At Advanced Dental Care of Norton, we have successfully placed
          thousands of implants with Dr. Gracia placing implants for over 25
          years.
          {"\n\n"}
          ...
          adequate bone to support the implant. You must also commit to keeping
          these structures healthy. Meticulous oral hygiene and regular dental
          visits are critical to the long-term success of dental implants.
        </Text>
      </View>
    );
  }
