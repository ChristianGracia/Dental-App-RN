            ...
            {!this.state.showProcedures ? (
              <View>
                ...
                <Text style={styles.itemPickText}>
                  ...
                  zirconia imlants. Zirconia is used when a patient has a metal
                  allergy and we are unable to use titanium.
                  {"\n\n"}
                  <Text style={{ fontWeight: "bold" }}>
                  ...
                  <Text>
                    The planning process for dental implants may involve a
                    variety of specialists which fortunately at Advanced Dental
                    Care of Norton we have all these specialists in-house.{" "}
                    {"\n"}
                    {"\n"}These specialist include a doctor who specializes in
                    conditions of the mouth, jaw and face (oral and
                    maxillofacial surgeon), a dentist specializing in treating
                    structures that support the teeth, such as gums and bones
                    (periodontist), a dentist who designs and fits artificial
                    teeth (prosthodontist). {"\n"}
                    {"\n"} Because dental implants require one or more surgical
                    procedures, you must have a thorough evaluation to prepare
                    ...
                    {"\n\n"}Tell your doctor about any medical conditions and
                    any medications you take, including prescription and
                    ...
                    {"\n"}
                    {"\n"}Your dental care team will instruct you about eating
                    and drinking before surgery, depending on what type of
                    anesthesia you have. If you're having sedation or general
                    anesthesia, plan to have someone take you home after surgery
                    and expect to rest for the remainder of the day.{"\n"}
                    {"\n"}
                  </Text>
                  <Text style={{ fontWeight: "bold" }}>
                    What to Expect{"\n"}
                  ...
                  <Text>
                    ...
                    performed in stages, with healing time between procedures.
                    The process of placing a dental implant involves multiple
                    steps, including:
                    ...
                    {"\n"}
                    The entire process can take many months from start to
                    finish. Much of that time is devoted to healing and waiting
                    for the growth of new bone in your jaw. Depending on your
                    situation, the specific procedure done or the materials
                    used, certain steps can sometimes be combined.
                    {"\n"}
                    {"\n"}
                  </Text>
                </Text>
